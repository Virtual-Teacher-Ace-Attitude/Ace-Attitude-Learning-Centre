...
namespace AceAttitude.Data.Migrations
{
    ...
    [Migration("20240221141657_StudentGrades")]
            ...
            modelBuilder.Entity("AceAttitude.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 21, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 22, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 23, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
            ...
            modelBuilder.Entity("AceAttitude.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CourseId = 2,
                            CreatedOn = new DateTime(2024, 3, 6, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            Likes = 7
                        },
                        new
                        {
                            ...
                            CourseId = 3,
                            CreatedOn = new DateTime(2024, 3, 24, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            Likes = 10
                        });
                });
            ...
            modelBuilder.Entity("AceAttitude.Data.Models.CommentLike", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ApplicationUserId = "11d15832-b94e-4be4-a892-14a07641adc3",
                            CommentId = 2,
                            CreatedOn = new DateTime(2024, 3, 7, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsLiked = true
                        },
                        new
                        {
                            ...
                            ApplicationUserId = "5422e8d8-d114-42b1-b878-f410f14e0be7",
                            CommentId = 3,
                            CreatedOn = new DateTime(2024, 3, 26, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsLiked = true
                        },
                        new
                        {
                            ...
                            CommentId = 3,
                            CreatedOn = new DateTime(2024, 3, 27, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsLiked = false
                        });
                });
            ...
            modelBuilder.Entity("AceAttitude.Data.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDraft = false,
                            Level = 0,
                            StartingDate = new DateTime(2024, 2, 21, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            TeacherId = "22cbe4de-2827-4458-b55f-779a19400ab5",
                        ...
                        new
                        {
                            Id = 2,
                            AgeGroup = 1,
                            CreatedOn = new DateTime(2024, 2, 28, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            Description = "This course thoroughly prepares high school students for their inaugural certification exam.",
                            IsCompleted = false,
                            IsDraft = false,
                            Level = 3,
                            StartingDate = new DateTime(2024, 3, 21, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            TeacherId = "aba81718-3f23-42ca-ba84-fcd9b4f4f944",
                        ...
                        new
                        {
                            Id = 3,
                            AgeGroup = 2,
                            CreatedOn = new DateTime(2024, 3, 21, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            Description = "Unlock your creativity with this masterclass on creative writing techniques and storytelling.",
                            IsCompleted = false,
                            IsDraft = true,
                            Level = 5,
                            StartingDate = new DateTime(2024, 4, 21, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            TeacherId = "89beab74-07ac-446a-8dc6-b0291b5ff68b",
            ...
            modelBuilder.Entity("AceAttitude.Data.Models.Rating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedOn = new DateTime(2024, 2, 24, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsRated = true,
                            StudentId = "64dfe826-08e8-4dcf-888b-c441fead8803",
                            Value = 4.8m
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 1,
                            CreatedOn = new DateTime(2024, 2, 25, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsRated = true,
                            StudentId = "11d15832-b94e-4be4-a892-14a07641adc3",
                            Value = 4.6m
                        },
                        new
                        {
                            Id = 3,
                            CourseId = 1,
                            CreatedOn = new DateTime(2024, 2, 26, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsRated = false,
                            StudentId = "5422e8d8-d114-42b1-b878-f410f14e0be7",
                            Value = 4.7m
                        });
            ...
            modelBuilder.Entity("AceAttitude.Data.Models.StudentCourses", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedOn = new DateTime(2024, 2, 18, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsApproved = true,
                            IsCompleted = true,
                            StudentId = "64dfe826-08e8-4dcf-888b-c441fead8803"
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 1,
                            CreatedOn = new DateTime(2024, 2, 17, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsApproved = true,
                            IsCompleted = true,
                            StudentId = "11d15832-b94e-4be4-a892-14a07641adc3"
                        },
                        new
                        {
                            Id = 3,
                            CourseId = 1,
                            CreatedOn = new DateTime(2024, 2, 16, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsApproved = true,
                            IsCompleted = true,
                            StudentId = "5422e8d8-d114-42b1-b878-f410f14e0be7"
                        },
                        new
                        {
                            Id = 4,
                            CourseId = 2,
                            CreatedOn = new DateTime(2024, 2, 29, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsApproved = true,
                            IsCompleted = false,
                            StudentId = "64dfe826-08e8-4dcf-888b-c441fead8803"
                        },
                        new
                        {
                            Id = 5,
                            CourseId = 2,
                            CreatedOn = new DateTime(2024, 3, 1, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsApproved = true,
                            IsCompleted = false,
                            StudentId = "11d15832-b94e-4be4-a892-14a07641adc3"
                        },
                        new
                        {
                            Id = 6,
                            CourseId = 2,
                            CreatedOn = new DateTime(2024, 3, 2, 16, 16, 57, 106, DateTimeKind.Local).AddTicks(5645),
                            IsApproved = true,
                            IsCompleted = false,
                            StudentId = "5422e8d8-d114-42b1-b878-f410f14e0be7"
                        });
